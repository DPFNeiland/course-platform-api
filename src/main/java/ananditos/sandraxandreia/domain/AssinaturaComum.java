...
public class AssinaturaComum implements Planos {
    ...
    public AssinaturaComum(String nome, String tipo, float preco, String funcionalidades) {
        this.nome = nome;
        this.tipo = tipo;
        this.preco = preco;
    ...
    public boolean equals(Object o) {
        ...
        AssinaturaComum that = (AssinaturaComum) o;
